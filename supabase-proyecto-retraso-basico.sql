-- SQL para automatización BÁSICA sin columnas opcionales
...
-- Insertar automatización BÁSICA (solo con columnas estándar)
...
VALUES (
    'Alerta Proyecto con Retraso (Básica)',
    'Detecta proyectos vencidos y crea notificaciones básicas',
    'project_delayed',
    '{
        "days_overdue": 0,
        "days_warning": 3,
