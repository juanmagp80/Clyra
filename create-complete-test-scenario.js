...
async function createCompleteTestScenario() {
    console.log('🎯 Iniciando creación de escenario de prueba completo...');
    ...
    try {
        ...
        const clientData = {
            id: 'client-test-' + Math.random().toString(36).substr(2, 8),
            user_id: userId,
            ...
            notes: 'Cliente premium con múltiples proyectos de desarrollo web y móvil. Muy exigente con los plazos y calidad. Prefiere comunicación directa y actualizaciones semanales.',
            status: 'active',
        ...
        // 3. Crear proyecto complejo
        const projectData = {
            id: 'project-test-' + Math.random().toString(36).substr(2, 8),
            user_id: userId,
            client_id: client.id,
            ...
            progress: 35,
            notes: 'Proyecto crítico para el Q4. Cliente muy exigente. Requisitos cambiantes. Tecnologías: React, Node.js, MongoDB, TensorFlow, AWS. Equipo de 4 desarrolladores. Reuniones semanales obligatorias.',
        ...
        const tasksData = [
            {
                ...
                description: 'Implementar sistema de machine learning para recomendaciones personalizadas usando TensorFlow y APIs de terceros',
                status: 'in_progress',
                priority: 'high',
            ...
            },
            {
                ...
                description: 'Integrar Stripe, PayPal y Bizum. Implementar sistema de reembolsos automáticos',
                status: 'pending',
                priority: 'high',
        ...
        // 5. Crear propuesta detallada
        const proposalData = {
            id: 'proposal-test-' + Math.random().toString(36).substr(2, 8),
            user_id: userId,
            client_id: client.id,
...
**FORMACIÓN:** 20 horas incluidas para el equipo del cliente`,
            ...
            terms: 'Condiciones de pago: 40% al inicio, 40% a mitad de proyecto, 20% al finalizar. Incluye 3 revisiones por módulo. Cambios adicionales se facturarán aparte a 85€/hora. Propiedad intelectual transferida al cliente al completar pagos.',
            notes: 'Cliente muy interesado pero necesita aprobación del CFO. Competencia directa con otra empresa (presupuesto 32k). Puntos fuertes: experiencia previa exitosa, equipo especializado. Debilidades: precio ligeramente superior, timeline ajustado.',
        ...
        // 6. Crear conversación completa y realista
        const messagesData = [
            {
...
¡Sigamos así! 💪`,
        ...
        console.log(`   ✅ Tareas: ${tasks.length} tareas del proyecto`);
        console.log('');
        console.log('🎯 AUTOMATIZACIONES LISTAS PARA PROBAR:');
        console.log('   ⚠️  Detector de Riesgos → Analizar proyecto "Plataforma E-commerce"');
        console.log('   📊 Analizador de Propuestas → Analizar "Expansión Sistema E-commerce"');
        console.log('   🧠 Análisis de Conversación → Analizar conversación con María González');
        console.log('   🎭 Análisis de Sentimiento → Usar último mensaje del cliente');
        console.log('   💬 Optimización de Comunicación → Optimizar cualquier mensaje');
        console.log('');
        console.log('✨ Todos los datos contienen información realista y compleja para probar el potencial completo de las automatizaciones de IA.');
