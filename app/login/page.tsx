                        ...
                        <div className="relative bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                            ...
                            <div className="grid grid-cols-1 gap-4 mb-8">
                                <Button
                                    ...
                                    disabled={loading}
                                    variant="ghost"
                                    className="border border-white/20 text-white hover:bg-white/20 hover:border-white/30 h-11 rounded-xl group transition-all duration-300 font-medium relative z-10"
                                >
