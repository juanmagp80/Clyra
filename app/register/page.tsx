                        ...
                        <div className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 shadow-2xl p-8 lg:p-12" style={{ animation: 'fadeInUp 0.7s ease-out', animationDelay: '0.2s' }}>
                            ...
                            <div className="grid grid-cols-1 gap-4 mb-8">
                                <Button
                                    ...
                                    variant="ghost"
                                    className="w-full border border-white/20 text-white bg-white/10 hover:bg-white/20 h-11 rounded-xl font-medium transition-all duration-300 relative z-10"
                                    disabled={loading}
                                >
