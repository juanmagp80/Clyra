                        ...
                        <div className="flex flex-col space-y-6">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-end">
                                ...
                                <div className="relative group/filter">
                                    ...
                                    <div className="relative bg-white/70 backdrop-blur-2xl border-2 border-white/80 rounded-2xl shadow-xl shadow-slate-500/10 group-hover/filter:shadow-lg transition-all duration-500">
                                ...
                                <div className="bg-white/90 backdrop-blur-3xl rounded-3xl border-2 border-white/80 shadow-2xl shadow-slate-500/20 relative overflow-hidden">
                                    ...
                                    <div className="relative bg-gradient-to-r from-blue-50/80 via-purple-50/80 to-indigo-50/80 backdrop-blur-xl p-8 border-b border-white/40">
                                        ...
                                        <div className="flex items-center gap-6">
                                            ...
                                            <div>
                                                <h3 className="text-3xl font-black bg-gradient-to-r from-slate-900 via-blue-700 to-purple-700 bg-clip-text text-transparent">
                                    ...
                                    <div className="p-8 space-y-8">
                                        ...
                                        <div className="flex gap-4 pt-8 border-t-2 border-white/40">
                                            ...
                                            <button
                                                onClick={() => setShowForm(false)}
                                                className="px-8 py-5 bg-white/80 backdrop-blur-xl border-2 border-white/80 hover:border-slate-300 rounded-2xl text-slate-700 font-bold hover:bg-slate-50 hover:scale-105 transition-all duration-300 flex items-center gap-3 text-lg shadow-lg hover:shadow-xl"
                                            >
                                                <X className="w-5 h-5" />
                                                Cancelar
                                            </button>
