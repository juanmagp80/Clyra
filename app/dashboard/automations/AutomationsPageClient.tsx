    ...
    const handleModalSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            for (const [index, action] of actions.entries()) {
                setExecutionLogs(prev => [...prev, `🔄 Ejecutando acción ${index + 1}/${actions.length}: ${action.name}`]);
                
                try {
                    // await executeAutomationAction(action, payload);
                    // Placeholder: ejecutar acción aquí
                    console.log('Ejecutando acción:', action.name, 'con payload:', payload);
            ...
            const sampleAutomations = [
                {
                    ...
                    description: 'Envía recordatorios automáticos a clientes sobre el progreso de sus proyectos',
                ...
                },
                {
                    ...
                    description: 'Notifica cuando una factura está próxima a vencer',
                    trigger_type: 'invoice_followup',
                    trigger_conditions: {"days_before_due": 7},
                    actions: [
                ...
                },
                {
                    ...
                    description: 'Automatiza el proceso de bienvenida para nuevos clientes',
                ...
                {
                    user_id: user.id,
                    name: 'Hitos de Proyecto',
                    description: 'Notifica cuando se completa un hito importante del proyecto',
                    trigger_type: 'project_milestone',
                    trigger_conditions: {"trigger": "milestone_completed"},
                    actions: [
                ...
                {
                    user_id: user.id,
                    name: 'Feedback de Cliente',
                    description: 'Solicita feedback automáticamente al completar un proyecto',
