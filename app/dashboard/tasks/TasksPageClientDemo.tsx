...
import { demoClients, demoProjects, demoTasks } from '../../demo/demo-data';
                        ...
                        {filteredAndSortedTasks.length === 0 ? (
                            ...
                            <div className="space-y-3">
                                {filteredAndSortedTasks.map((task) => (
                                    <div
                                        key={task.id}
                                        className={`border rounded-lg p-4 transition-all hover:shadow-md ${activeTracking === task.id ? 'bg-blue-50 border-blue-200' : 'bg-white'
                                            ...
                                            <div className="flex items-start space-x-3 flex-1">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center space-x-2 mb-1">
                                                        <h4 className={`font-medium truncate ${task.status === 'completed'
                                                    ...
                                                    <div className="flex items-center space-x-4 text-sm text-gray-500 mb-2">
                                                        {task.due_date && (
                                                            <span className={`flex items-center ${isPast(new Date(task.due_date)) && task.status !== 'completed'
