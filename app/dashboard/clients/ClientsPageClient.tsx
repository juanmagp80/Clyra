                                ...
                                <div className={"group p-8 hover:scale-[1.01] transition-all duration-500 relative overflow-hidden bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm"}>
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 relative z-10">
                                        ...
                                        <button
                                            ...
                                            className={`group/btn relative px-8 py-4 rounded-2xl font-bold shadow-2xl transform transition-all duration-300 flex items-center gap-3 overflow-hidden ${!canUseFeatures || hasReachedLimit('clients')
                                ...
                                <div className="flex flex-col space-y-6">
                                    ...
                                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                                        ...
                                        <div className="flex items-center gap-2 bg-white/60 backdrop-blur-xl rounded-2xl p-2 shadow-lg border border-white/80">
                                            <button
                                                ...
                                                className={`group flex items-center gap-2 px-4 py-2 rounded-xl font-bold text-sm transition-all duration-300 ${viewMode === 'cards'
                                    ...
                                    <div className="flex justify-center">
                                        <button
                                            onClick={handleNewClientClick}
                                            disabled={!canUseFeatures || hasReachedLimit('clients')}
                                            className={`group px-10 py-5 font-black rounded-3xl shadow-2xl transition-all duration-500 flex items-center gap-4 text-lg relative overflow-hidden ${!canUseFeatures || hasReachedLimit('clients')
                                                            ...
                                                            {searchTerm ? (
                                                                <>
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        disabled={!canUseFeatures || hasReachedLimit('clients')}
                                                                        className={`group px-8 py-4 font-bold rounded-2xl shadow-2xl transition-all duration-300 flex items-center gap-3 ${!canUseFeatures || hasReachedLimit('clients')
                                                                                ? 'bg-gray-400 cursor-not-allowed opacity-50 text-white'
                                                                ...
                                                                <button
                                                                    onClick={handleNewClientClick}
                                                                    disabled={!canUseFeatures || hasReachedLimit('clients')}
                                                                    className={`group px-10 py-5 font-bold rounded-2xl shadow-2xl transition-all duration-300 flex items-center gap-4 text-lg ${!canUseFeatures || hasReachedLimit('clients')
                                                                            ? 'bg-gray-400 cursor-not-allowed opacity-50 text-white'
                                                                            : 'bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 text-white shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-110 hover:-translate-y-2'
                                                                        }`}
                                                                >
