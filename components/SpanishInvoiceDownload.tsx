...
interface SpanishInvoiceDownloadProps {
    invoiceId: string;
...
export function SpanishInvoiceDownload({
    invoiceId,
    invoiceNumber,
    variant = 'outline',
    size = 'sm',
    className = ''
}: SpanishInvoiceDownloadProps) {
...
interface SpanishInvoicePreviewProps extends SpanishInvoiceDownloadProps {
    onPreview?: () => void;
}

export function SpanishInvoicePreview({
    invoiceId,
    invoiceNumber,
    variant = 'ghost',
    size = 'sm',
...
// Hook para validar si se puede generar PDF español
export function useSpanishInvoiceValidation() {
